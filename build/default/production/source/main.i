...
# 23 "source/./../header/preambleInitialization.h"
...
void main(void)
{
  ...
  while (1)
  {
      if(casove_preruseni == 1){
          ...
          if (koder.pocet == 0 && S4.zaaretovane == 0){
              PORTFbits.RF2 = 1;
          }
          else if (koder.pocet == 255 && S4.zaaretovane == 0){
              PORTFbits.RF1 = 1;
          }
          else if (ADprevod == 0 && S4.zaaretovane == 1){
              PORTFbits.RF2 = 1;
          }
          else if (ADprevod == 255 && S4.zaaretovane == 1){
              PORTFbits.RF1 = 1;
          }
